...
<head>
  ...
  <title>UKDW P.P | Riwayat Peminjaman</title>
...
<nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/databarangdosen" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/fpinjamdosen" class="nav-link">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 style="text-align:center;">Riwayat Peminjaman</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Peminjaman yang anda lakukan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
