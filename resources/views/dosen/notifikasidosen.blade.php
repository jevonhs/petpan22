...
<head>
  ...
  <title>UKDW P.P | Notifikasi</title>
...
<!-- Sidebar Menu -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dosen/barang" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/dosen/booking" class="nav-link">
...
<!-- /.sidebar -->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 style="text-align:center;">NOTIFIKASI PEMINJAMAN</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td>28/03/22</td>
                    <td>Permohonan peminjaman anda diterima</td>
                    <td><a href="#" class="btn btn-danger">Hapus</a></td>
            </tr>
                  <tr>
                    <td>28/03/22</td>
                    <td>Waktu peminjaman anda sudah tinggal 1 hari</td>
                    <td><a href="#" class="btn btn-danger">Hapus</a></td>
